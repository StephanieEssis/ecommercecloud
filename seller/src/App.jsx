...
// import ProductList from "./components/ProductList/ProductList"; // adapte le chemin si besoin
...
import ProductList from "./components/ProductList/ProductList"; // ✅ Ajout ici
...
const App = () => {
  return (
    <Router>
      ...
      <Routes>
        <Route path="/" element={<Home />} />
        <Route path="/products" element={<Products />} /> {/* Page principale des produits */}
